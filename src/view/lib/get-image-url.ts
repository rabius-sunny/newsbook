export function defaultImg({
 ...
 const scale = Math.min(naturalScale, 0.3)
 ...
 const svg = `
    <svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" fill="#f3f4f6" role="img" aria-label="placeholder image">
